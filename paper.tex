...
Certain challenges faced by nearly all
...
current representation systems. A more challenging aspect is
...
field. This disparity could be attributed to the fact that 
the outcomes from cheminformatics methods
...
candidates, while bioinformatics software is employed in
upstream areas such as target identification, 
perhaps not as directly related to
...
%example) are much easier to obtain. 
While both fields have theoretical
