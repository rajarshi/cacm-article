...
of data from disparate chemical databasesremains a challenge, not only due to the
...
elucidation} of natural compounds such as metabolites, to name just one example. 
...
only on small molecule features, and therefore lose valuable information. As a
...
ideally will require that multiple structural forms be taken into 
account simultaneously with receptor aspects. 
