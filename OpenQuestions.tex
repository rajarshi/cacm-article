...
problem is such that given a molecule structure representation
(usually a descriptor vector), what are the possible input structures
that satisfy the representation. This can be made more complex, by
asking that the input structures also satisfy aexperimental property
range.
\begin{itemize}
