...
driven by many factors including ease of use and regulatory
compliance. In chemistry, every experiment requires significant domain
expertise and provenance information (especially in industrial
settings where an experiment might be a key component of a patent
filing). ELNs play an important role in reducing the risks associated
with information loss by allowing easy sharing and retrieval of domain
knowledge, securing sensitive data, ensuring data is time stamped and
in general maintaining an audit trail of all experiemnts and data
